### Note: The upgraded version of this project which is live on internet. This upgrade handles the agent trigger and stop functionality through an asynchronous web app.
